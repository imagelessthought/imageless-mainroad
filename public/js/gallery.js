...
document.addEventListener("DOMContentLoaded", function () {
  ...
  Box_1.addEventListener('mouseover', function() {
    modal.style.backgroundColor = 'var(--box-bg1)';
  });
  ...
  Box_2.addEventListener('mouseover', function() {
    modal.style.backgroundColor = 'var(--box-bg2)';
  });
  ...
  Box_3.addEventListener('mouseover', function() {
    modal.style.backgroundColor = 'var(--box-bg3)';
  });
  Box_3.addEventListener('mouseleave', function() {
    modal.style.backgroundColor = ''; // Reset to default
  });
  ...
  let totalPages = 1;
    ...
    displayImages();
    // No additional closing brace needed here
  });
